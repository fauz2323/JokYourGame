                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  controller.orderRecipeModel.orderList.status,
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.w400),
                                ),
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  RowRecipe(
                                    tittel: "Username",
                                    data: controller.orderRecipeModel.orderList
                                        .user.username,
                                  ),
                                  RowRecipe(
                                    tittel: "Email",
                                    data: controller
                                        .orderRecipeModel.orderList.user.email,
                                  ),
                                  RowRecipe(
                                    tittel: "Phone",
                                    data: controller
                                        .orderRecipeModel.orderList.user.phone,
                                  ),
                                  SizedBox(
                                    height: 10,
                                  ),
